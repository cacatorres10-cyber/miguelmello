...
export function PageBackground() {
  return (
    ...
    >
      <BackgroundPathsLayer cover className="opacity-[0.55]" />
      ...
      <div className="absolute inset-0 bg-[radial-gradient(90%_75%_at_50%_45%,transparent_40%,rgba(10,10,10,0.8)_100%)]" />
    </div>
  );
}

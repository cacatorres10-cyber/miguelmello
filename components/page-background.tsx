...
export function PageBackground() {
  return (
    ...
    >
      <BackgroundPathsLayer cover className="opacity-40" />
      ...
      <div className="absolute inset-0 bg-[radial-gradient(85%_70%_at_50%_45%,transparent_25%,rgba(10,10,10,0.85)_100%)]" />
    </div>
  );
}
